        ...
        <section className="w-full py-12 px-4 sm:px-8 lg:px-12 max-w-[1400px] mx-auto">
            ...
            <div className={`grid gap-6 ${viewMode === 'grid' ? 'grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4' : 'grid-cols-1'}`}>
                {paginatedProducts.length > 0 ? (
                    ...
                    <div className={`relative bg-[#f4f2ee] flex items-center justify-center overflow-hidden ${viewMode === 'list' ? 'w-full md:w-[260px] h-[265px] shrink-0' : 'aspect-square p-4'}`}>
                        ...
                        src={product.image} 
                        alt={product.title} 
                        className={`w-full h-full object-contain transition-transform duration-500 mix-blend-multiply ${viewMode === 'list' ? 'p-6 aspect-[3/4]' : ''}`}
                        />
                    </div>
                    ...
                    <div className={`p-4 flex flex-col flex-grow bg-white ${viewMode === 'list' ? 'md:p-6' : ''}`}>
                        ...
                        <h3 className={`${viewMode === 'list' ? 'text-lg' : 'text-sm'} font-bold text-gray-900 leading-tight mb-3 line-clamp-2`}>
                        {product.title}
                        </h3>
